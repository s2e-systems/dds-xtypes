...
xtypes_v2_extensibility_test_suite = {
    'ext_final_struct_1' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_f1 -V data/xml/struct_1.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_f1 -V data/xml/struct_1.xml -J data/json/struct_num_x1.json --ignore-member-names f'],
    ...
    'ext_final_struct_2' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_f1 -V data/xml/struct_1.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_f2 -V data/xml/struct_1.xml -J data/json/struct_num_x1.json --ignore-member-names f'],
    ...
    'ext_appendable_struct_1' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_a1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_a1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json --ignore-member-names f'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'ext_appendable_struct_2' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_a1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_a2 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json --ignore-member-names f'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'ext_appendable_struct_3' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_a2 -V data/xml/struct_num_x1_x2.xml -J data/json/struct_num_x1_x2.json',
                  'sub-exe -S -t test -y Test::struct_a1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json --ignore-member-names f'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
    ...
    'ext_appendable_struct_4' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_a2 -V data/xml/struct_1.xml -J data/json/struct_num_x1_x2.json',
                  'sub-exe -S -t test -y Test::struct_a3 -V data/xml/struct_1.xml -J data/json/struct_num_x1_x2.json --ignore-member-names f'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'ext_appendable_struct_5' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_a3 -V data/xml/struct_1.xml -J data/json/struct_num_x1_x3_x2.json',
                  'sub-exe -S -t test -y Test::struct_a2 -V data/xml/struct_1.xml -J data/json/struct_num_x1_x2.json --ignore-member-names f'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'ext_mutable_struct_1' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_m1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_m1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json --ignore-member-names f'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'ext_mutable_struct_2' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_m1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_m2 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json --ignore-member-names f'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'ext_mutable_struct_3' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_m2 -V data/xml/struct_num_x1_x2.xml -J data/json/struct_num_x1_x2.json',
                  'sub-exe -S -t test -y Test::struct_m1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json --ignore-member-names f'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
    ...
    'ext_mutable_struct_4' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_m2 -V data/xml/struct_num_x1_x2.xml -J data/json/struct_num_x1_x2.json',
                  'sub-exe -S -t test -y Test::struct_m3 -V data/xml/struct_num_x1_x2.xml -J data/json/struct_num_x1_x2.json --ignore-member-names f'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'ext_mutable_struct_5' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_m3 -V data/xml/struct_num_x1_x3_x2.xml -J data/json/struct_num_x1_x3_x2.json',
                  'sub-exe -S -t test -y Test::struct_m2 -V data/xml/struct_num_x1_x2.xml -J data/json/struct_num_x1_x2.json --ignore-member-names f'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'ext_mutable_struct_6' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_m2 -V data/xml/struct_num_x1_x2.xml -J data/json/struct_num_x1_x2.json',
                  'sub-exe -S -t test -y Test::struct_m4 -V data/xml/struct_num_x1_x2.xml -J data/json/struct_num_x1_x2.json --ignore-member-names f'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'ext_autoid_1' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_hashid_1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_hashid_2 -V data/xml/struct_num_x2.xml -J data/json/struct_num_x2.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
...
xtypes_v2_type_consistency_test_suite = {
    'tc_force_type_validation_1' : {
        'apps' : ['pub-exe -P -t test -X types/xml/type_consistency.xml                -y Test::struct_x1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json --disable-type-info',
                  'sub-exe -S -t test -X types/xml/type_consistency_force_type_val.xml -y Test::struct_x1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json --force-type-validation t --disable-type-info'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_force_type_validation_2' : {
        'apps' : ['pub-exe -P -t test -X types/xml/type_consistency.xml                -y Test::struct_x1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json --disable-type-info',
                  'sub-exe -S -t test -X types/xml/type_consistency_force_type_val.xml -y Test::struct_x1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json --force-type-validation f --disable-type-info'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_force_type_validation_3' : {
        'apps' : ['pub-exe -P -t test -X types/xml/type_consistency.xml -y Test::struct_x1 -V data/xml/struct_1.xml -J data/json/struct_num_x1.json --disable-type-info',
                  'sub-exe -S -t test -X types/xml/type_consistency_force_type_val.xml -y Test::struct_x1 -V data/xml/struct_1.xml -J data/json/struct_num_x1.json --force-type-validation d --disable-type-info'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_ignore_member_names_1' : {
        'common_args' : ['-X types/xml/type_consistency.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_x1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_x2 -V data/xml/struct_num_x2.xml -J data/json/struct_num_x2.json --ignore-member-names t'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_ignore_member_names_2' : {
        'common_args' : ['-X types/xml/type_consistency.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_x1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_x2 -V data/xml/struct_num_x2.xml -J data/json/struct_num_x2.json --ignore-member-names f'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_ignore_member_names_3' : {
        'common_args' : ['-X types/xml/type_consistency.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_x1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_x2 -V data/xml/struct_num_x2.xml -J data/json/struct_num_x2.json --ignore-member-names d'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_ignore_seq_bounds_1' : {
        'common_args' : ['-X types/xml/type_consistency.xml'],
        'apps' : ['pub-exe -P -t test -y Test::seq_int32x10 -V data/xml/array_num_10.xml -J data/json/array_num_10.json',
                  'sub-exe -S -t test -y Test::seq_int32x20 -V data/xml/array_num_10.xml -J data/json/array_num_10.json --ignore-seq-bounds t'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_ignore_seq_bounds_2' : {
        'common_args' : ['-X types/xml/type_consistency.xml'],
        'apps' : ['pub-exe -P -t test -y Test::seq_int32x10 -V data/xml/array_num_10.xml -J data/json/array_num_10.json',
                  'sub-exe -S -t test -y Test::seq_int32x20 -V data/xml/array_num_10.xml -J data/json/array_num_10.json --ignore-seq-bounds f'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_ignore_seq_bounds_3' : {
        'common_args' : ['-X types/xml/type_consistency.xml'],
        'apps' : ['pub-exe -P -t test -y Test::seq_int32x10 -V data/xml/array_num_10.xml -J data/json/array_num_10.json',
                  'sub-exe -S -t test -y Test::seq_int32x20 -V data/xml/array_num_10.xml -J data/json/array_num_10.json --ignore-seq-bounds d'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_ignore_seq_bounds_4' : {
        'common_args' : ['-X types/xml/type_consistency.xml'],
        'apps' : ['pub-exe -P -t test -y Test::seq_int32x20 -V data/xml/array_num_20.xml -J data/json/array_num_20.json',
                  'sub-exe -S -t test -y Test::seq_int32x10 -V data/xml/array_num_10.xml -J data/json/array_num_10.json --ignore-seq-bounds t'],
    ...
    'tc_ignore_seq_bounds_5' : {
        'common_args' : ['-X types/xml/type_consistency.xml'],
        'apps' : ['pub-exe -P -t test -y Test::seq_int32x20 -V data/xml/array_num_20.xml -J data/json/array_num_20.json',
                  'sub-exe -S -t test -y Test::seq_int32x10 -V data/xml/array_num_10.xml -J data/json/array_num_10.json --ignore-seq-bounds f'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_ignore_seq_bounds_6' : {
        'common_args' : ['-X types/xml/type_consistency.xml'],
        'apps' : ['pub-exe -P -t test -y Test::seq_int32x20 -V data/xml/array_num_20.xml -J data/json/array_num_20.json',
                  'sub-exe -S -t test -y Test::seq_int32x10 -V data/xml/array_num_10.xml -J data/json/array_num_10.json --ignore-seq-bounds d'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_ignore_seq_bounds_7' : {
        'common_args' : ['-X types/xml/type_consistency.xml'],
        'apps' : ['pub-exe -P -t test -y Test::seq_int32x20 -V data/xml/array_num_10.xml -J data/json/array_num_10.json',
                  'sub-exe -S -t test -y Test::seq_int32x10 -V data/xml/array_num_10.xml -J data/json/array_num_10.json --ignore-seq-bounds t'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
    ...
    'tc_ignore_str_bounds_1' : {
        'common_args' : ['-X types/xml/type_consistency.xml'],
        'apps' : ['pub-exe -P -t test -y Test::string10 -V data/xml/strings_hello.xml -J data/json/strings_hello.json',
                  'sub-exe -S -t test -y Test::string20 -V data/xml/strings_hello.xml -J data/json/strings_hello.json --ignore-str-bounds t'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_ignore_str_bounds_2' : {
        'common_args' : ['-X types/xml/type_consistency.xml'],
        'apps' : ['pub-exe -P -t test -y Test::string10 -V data/xml/strings_hello.xml -J data/json/strings_hello.json',
                  'sub-exe -S -t test -y Test::string20 -V data/xml/strings_hello.xml -J data/json/strings_hello.json --ignore-str-bounds f'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_ignore_str_bounds_3' : {
        'common_args' : ['-X types/xml/type_consistency.xml'],
        'apps' : ['pub-exe -P -t test -y Test::string10 -V data/xml/strings_hello.xml -J data/json/strings_hello.json',
                  'sub-exe -S -t test -y Test::string20 -V data/xml/strings_hello.xml -J data/json/strings_hello.json --ignore-str-bounds d'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_ignore_str_bounds_4' : {
        'common_args' : ['-X types/xml/type_consistency.xml'],
        'apps' : ['pub-exe -P -t test -y Test::string20 -V data/xml/strings.xml -J data/json/strings.json',
                  'sub-exe -S -t test -y Test::string10 -V data/xml/strings.xml -J data/json/strings.json --ignore-str-bounds t'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_ignore_str_bounds_5' : {
        'common_args' : ['-X types/xml/type_consistency.xml'],
        'apps' : ['pub-exe -P -t test -y Test::string20 -V data/xml/strings.xml -J data/json/strings.json',
                  'sub-exe -S -t test -y Test::string10 -V data/xml/strings.xml -J data/json/strings.json --ignore-str-bounds f'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_ignore_str_bounds_6' : {
        'common_args' : ['-X types/xml/type_consistency.xml'],
        'apps' : ['pub-exe -P -t test -y Test::string20 -V data/xml/strings.xml -J data/json/strings.json',
                  'sub-exe -S -t test -y Test::string10 -V data/xml/strings.xml -J data/json/strings.json --ignore-str-bounds d'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_ignore_str_bounds_7' : {
        'common_args' : ['-X types/xml/type_consistency.xml'],
        'apps' : ['pub-exe -P -t test -y Test::string20 -V data/xml/strings_hello.xml -J data/json/strings_hello.json',
                  'sub-exe -S -t test -y Test::string10 -V data/xml/strings_hello.xml -J data/json/strings_hello.json --ignore-str-bounds t'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_prevent_type_widening_1' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_f1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_f2 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json --prevent-type-widening t'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_prevent_type_widening_2' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_f1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_f2 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json --prevent-type-widening f'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_prevent_type_widening_3' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_f1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_f2 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json --prevent-type-widening d'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_prevent_type_widening_4' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_a1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_a2 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json --prevent-type-widening t'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_prevent_type_widening_5' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_a1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_a2 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json --prevent-type-widening f'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_prevent_type_widening_6' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_a1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_a2 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json --prevent-type-widening d'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_prevent_type_widening_7' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_m1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_m2 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json --prevent-type-widening t'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_prevent_type_widening_8' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_m1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_m2 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json --prevent-type-widening f'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tc_prevent_type_widening_9' : {
        'common_args' : ['-X types/xml/extensibility.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_m1 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_m2 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json --prevent-type-widening d'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
...
xtypes_v2_array_test_suite = {
    'int32[10]' : {
        'common_args' : ['-X types/xml/arrays.xml'],
        'apps' : ['pub-exe -P -t test -y Test::int32x10 -V data/xml/array_num_10.xml -J data/json/array_num_10.json',
                  'sub-exe -S -t test -y Test::int32x10 -V data/xml/array_num_10.xml -J data/json/array_num_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
    ...
    'int32[10]_int32[20]' : {
        'common_args' : ['-X types/xml/arrays.xml'],
        'apps' : ['pub-exe -P -t test -y Test::int32x10 -V data/xml/array_num_10.xml -J data/json/array_num_10.json',
                  'sub-exe -S -t test -y Test::int32x20 -V data/xml/array_num_20.xml -J data/json/array_num_20.json'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
    ...
    'int32[10]_uint32[10]' : {
        'common_args' : ['-X types/xml/arrays.xml'],
        'apps' : ['pub-exe -P -t test -y Test::int32x10 -V data/xml/array_num_10.xml -J data/json/array_num_10.json',
                  'sub-exe -S -t test -y Test::uint32x10 -V data/xml/array_num_10.xml -J data/json/array_num_10.json'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
    ...
    'int32[10][2]_int32[20]' : {
        'common_args' : ['-X types/xml/arrays.xml'],
        'apps' : ['pub-exe -P -t test -y Test::int32x10x2 -V data/xml/array_num_20.xml -J data/json/array_num_20.json',
                  'sub-exe -S -t test -y Test::int32x20 -V data/xml/array_num_20.xml -J data/json/array_num_20.json'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : 'No communication between arrays of different types',
    ...
    'string10[10]_string20[10]' : {
        'common_args' : ['-X types/xml/arrays.xml'],
        'apps' : ['pub-exe -P -t test -y Test::string10x10 -V data/xml/array_string_10.xml -J data/json/array_string_10.json',
                  'sub-exe -S -t test -y Test::string20x10 -V data/xml/array_string_10.xml -J data/json/array_string_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'enum1[10]_enum2[10]' : {
        'common_args' : ['-X types/xml/arrays.xml'],
        'apps' : ['pub-exe -P -t test -y Test::enum1x10 -V data/xml/array_enum_10.xml -J data/json/array_enum_10.json',
                  'sub-exe -S -t test -y Test::enum2x10 -V data/xml/array_enum_10.xml -J data/json/array_enum_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'appendable_enum' : {
        'common_args' : ['-X types/xml/arrays.xml'],
        'apps' : ['pub-exe -P -t test -y Test::enum1 -V data/xml/enum.xml -J data/json/enum.json',
                  'sub-exe -S -t test -y Test::enum2 -V data/xml/enum.xml -J data/json/enum.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'SFinal[10]_S[20]_SFinalAlt[10]_S[20]' : {
        'common_args' : ['-X types/xml/arrays.xml'],
        'apps' : ['pub-exe -P -t test -y Test::F_S__array10_F_S__array20_uint32 -V data/xml/array_array_num_10_20.xml -J data/json/array_array_num_10_20.json',
                  'sub-exe -S -t test -y Test::F_S__array10_F_S__array20_uint32_alt -V data/xml/array_array_num_10_20_alt.xml -J data/json/array_array_num_10_20_alt.json'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'SAppendable[10]_S[20]_SAppendableAlt[10]_S[20]' : {
        'common_args' : ['-X types/xml/arrays.xml'],
        'apps' : ['pub-exe -P -t test -y Test::F_S__array10_A_S__array20_uint32 -V data/xml/array_array_num_10_20.xml -J data/json/array_array_num_10_20.json',
                  'sub-exe -S -t test -y Test::F_S__array10_A_S__array20_uint32_alt -V data/xml/array_array_num_10_20_alt.xml -J data/json/array_array_num_10_20_alt.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'SMutable[10]_S[20]_SMutableAlt[10]_S[20]' : {
        'common_args' : ['-X types/xml/arrays.xml'],
        'apps' : ['pub-exe -P -t test -y Test::F_S__array10_M_S__array20_uint32 -V data/xml/array_array_num_10_20.xml -J data/json/array_array_num_10_20.json',
                  'sub-exe -S -t test -y Test::F_S__array10_M_S__array20_uint32_alt -V data/xml/array_array_num_10_20_alt.xml -J data/json/array_array_num_10_20_alt.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
...
xtypes_v2_sequence_test_suite = {
    ...
    'seq(int32)_seq(int32,10)' : {
        'common_args' : ['-X types/xml/sequences.xml'],
        'apps' : ['pub-exe -P -t test -y Test::int32_unbounded -V data/xml/array_num_10.xml -J data/json/array_num_10.json',
                  'sub-exe -S -t test -y Test::int32x10 -V data/xml/array_num_10.xml -J data/json/array_num_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
    ...
    'seq(int32)_seq(int32,10)_check_bounds' : {
        'common_args' : ['-X types/xml/sequences.xml'],
        'apps' : ['pub-exe -P -t test -y Test::int32_unbounded -V data/xml/array_num_10.xml -J data/json/array_num_10.json',
                  'sub-exe -S -t test -y Test::int32x10 -V data/xml/array_num_10.xml -J data/json/array_num_10.json --ignore-seq-bounds f'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'seq(int32,20)_seq(int32,10)' : {
        'common_args' : ['-X types/xml/sequences.xml'],
        'apps' : ['pub-exe -P -t test -y Test::int32x20 -V data/xml/array_num_20.xml -J data/json/array_num_20.json',
                  'sub-exe -S -t test -y Test::int32x10 -V data/xml/array_num_10.xml -J data/json/array_num_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
    ...
    'seq(int32,10)_seq(int32,20)' : {
        'common_args' : ['-X types/xml/sequences.xml'],
        'apps' : ['pub-exe -P -t test -y Test::int32x10 -V data/xml/array_num_10.xml -J data/json/array_num_10.json',
                  'sub-exe -S -t test -y Test::int32x20 -V data/xml/array_num_10.xml -J data/json/array_num_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'seq(int32,10)_seq(int32,20)_check_bounds' : {
        'common_args' : ['-X types/xml/sequences.xml'],
        'apps' : ['pub-exe -P -t test -y Test::int32x10 -V data/xml/array_num_10.xml -J data/json/array_num_10.json',
                  'sub-exe -S -t test -y Test::int32x20 -V data/xml/array_num_10.xml -J data/json/array_num_10.json --ignore-seq-bounds f'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'seq(str20,10)_seq(str10,10)' : {
        'common_args' : ['-X types/xml/sequences.xml'],
        'apps' : ['pub-exe -P -t test -y Test::string20x10 -V data/xml/array_string_10.xml -J data/json/array_string_10.json',
                  'sub-exe -S -t test -y Test::string10x10 -V data/xml/array_string_10.xml -J data/json/array_string_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'seq(str20,10)_seq(str10,10)_check' : {
        'common_args' : ['-X types/xml/sequences.xml'],
        'apps' : ['pub-exe -P -t test -y Test::string20x10 -V data/xml/array_string_10.xml -J data/json/array_string_10.json',
                  'sub-exe -S -t test -y Test::string10x10 -V data/xml/array_string_10.xml -J data/json/array_string_10.json --ignore-str-bounds f'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'seq(enum1)_seq(enum2)' : {
        'common_args' : ['-X types/xml/sequences.xml'],
        'apps' : ['pub-exe -P -t test -y Test::enum1 -V data/xml/array_enum_10.xml -J data/json/array_enum_10.json',
                  'sub-exe -S -t test -y Test::enum2 -V data/xml/array_enum_10.xml -J data/json/array_enum_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'seq(SFinal,10)_seq(SFinalAlt,10)' : {
        'common_args' : ['-X types/xml/sequences.xml'],
        'apps' : ['pub-exe -P -t test -y Test::F_S__seq10_F_S__seq20_uint32 -V data/xml/array_array_num_10_20.xml -J data/json/array_array_num_10_20.json',
                  'sub-exe -S -t test -y Test::F_S__seq10_F_S__seq20_uint32_alt -V data/xml/array_array_num_10_20.xml -J data/json/array_array_num_10_20_alt.json'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'seq(SAppendable,10)_seq(SAppendableAlt,10)' : {
        'common_args' : ['-X types/xml/sequences.xml'],
        'apps' : ['pub-exe -P -t test -y Test::F_S__seq10_A_S__seq20_uint32 -V data/xml/array_array_num_10_20.xml -J data/json/array_array_num_10_20.json',
                  'sub-exe -S -t test -y Test::F_S__seq10_A_S__seq20_uint32_alt -V data/xml/array_array_num_10_20_alt.xml -J data/json/array_array_num_10_20_alt.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'seq(SMutable,10)_seq(SMutableAlt,10)' : {
        'common_args' : ['-X types/xml/sequences.xml'],
        'apps' : ['pub-exe -P -t test -y Test::F_S__seq10_M_S__seq20_uint32 -V data/xml/array_array_num_10_20.xml -J data/json/array_array_num_10_20.json',
                  'sub-exe -S -t test -y Test::F_S__seq10_M_S__seq20_uint32_alt -V data/xml/array_array_num_10_20_alt.xml -J data/json/array_array_num_10_20_alt.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
...
xtypes_v2_string_test_suite = {
    'string_string' : {
        'common_args' : ['-X types/xml/strings.xml'],
        'apps' : ['pub-exe -P -t test -y Test::string_unbounded -V data/xml/strings.xml -J data/json/strings.json',
                  'sub-exe -S -t test -y Test::string_unbounded -V data/xml/strings.xml -J data/json/strings.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'string_string10' : {
        'common_args' : ['-X types/xml/strings.xml'],
        'apps' : ['pub-exe -P -t test -y Test::string_unbounded -V data/xml/strings.xml -J data/json/strings.json',
                  'sub-exe -S -t test -y Test::string10 -V data/xml/strings.xml -J data/json/strings.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'wstring_wstring' : {
        'common_args' : ['-X types/xml/strings.xml'],
        'apps' : ['pub-exe -P -t test -y Test::wstring_unbounded -V data/xml/wstrings.xml -J data/json/wstrings.json',
                  'sub-exe -S -t test -y Test::wstring_unbounded -V data/xml/wstrings.xml -J data/json/wstrings.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'wstring_wstring10' : {
        'common_args' : ['-X types/xml/strings.xml'],
        'apps' : ['pub-exe -P -t test -y Test::wstring_unbounded -V data/xml/wstrings.xml -J data/json/wstrings.json',
                  'sub-exe -S -t test -y Test::wstring10 -V data/xml/wstrings.xml -J data/json/wstrings.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'wstring_wstring10_check' : {
        'common_args' : ['-X types/xml/strings.xml'],
        'apps' : ['pub-exe -P -t test -y Test::wstring_unbounded -V data/xml/wstrings.xml -J data/json/wstrings.json',
                  'sub-exe -S -t test -y Test::wstring10 -V data/xml/wstrings.xml -J data/json/wstrings.json --ignore-str-bounds f'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'wstring10_wstring20_check' : {
        'common_args' : ['-X types/xml/strings.xml'],
        'apps' : ['pub-exe -P -t test -y Test::wstring10 -V data/xml/wstrings_hello.xml -J data/json/wstrings_hello.json',
                  'sub-exe -S -t test -y Test::wstring20 -V data/xml/wstrings_hello.xml -J data/json/wstrings_hello.json --ignore-str-bounds f'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'wstring20_wstring10_check' : {
        'common_args' : ['-X types/xml/strings.xml'],
        'apps' : ['pub-exe -P -t test -y Test::wstring20 -V data/xml/wstrings.xml -J data/json/wstrings.json',
                  'sub-exe -S -t test -y Test::wstring10 -V data/xml/wstrings.xml -J data/json/wstrings.json --ignore-str-bounds f'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
...
xtypes_v2_struct_test_suite = {
    ...
    'primitives_struct_final' : {
        'common_args' : ['-X types/xml/primitives.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_primitives_final -V data/xml/struct_primitives.xml -J data/json/struct_primitives.json',
                  'sub-exe -S -t test -y Test::struct_primitives_final -V data/xml/struct_primitives.xml -J data/json/struct_primitives.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'primitives_struct_appendable' : {
        'common_args' : ['-X types/xml/primitives.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_primitives_appendable -V data/xml/struct_primitives.xml -J data/json/struct_primitives.json',
                  'sub-exe -S -t test -y Test::struct_primitives_appendable -V data/xml/struct_primitives.xml -J data/json/struct_primitives.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'primitives_struct_mutable': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitives_mutable -V data/xml/struct_primitives.xml -J data/json/struct_primitives.json',
                 'sub-exe -S -t test -y Test::struct_primitives_mutable -V data/xml/struct_primitives.xml -J data/json/struct_primitives.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_different_ids_ok': {
        'common_args': ['-X types/xml/struct_names.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_1 -V data/xml/struct_num_x1_x5.xml -J data/json/struct_num_x1_x5.json',
                 'sub-exe -S -t test -y Test::struct_2 -V data/xml/struct_num_x5.xml -J data/json/struct_num_x5.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_different_ids': {
        'common_args': ['-X types/xml/struct_names.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_1 -V data/xml/struct_num_x1_x5.xml -J data/json/struct_num_x1_x5.json',
                 'sub-exe -S -t test -y Test::struct_2 -V data/xml/struct_num_x1_x5.xml -J data/json/struct_num_x1_x5.json --ignore-member-names f'
        ],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
    ...
    'struct_different_names_ok': {
        'common_args': ['-X types/xml/struct_names.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_3 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_4 -V data/xml/struct_num_x2.xml -J data/json/struct_num_x2.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_different_names': {
        'common_args': ['-X types/xml/struct_names.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_3 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_4 -V data/xml/struct_num_x2.xml -J data/json/struct_num_x2.json --ignore-member-names f'
        ],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
    ...
    'struct_no_common_ids': {
        'common_args': ['-X types/xml/struct_names.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_5 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_6 -V data/xml/struct_num_x2.xml -J data/json/struct_num_x2.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_members_assignable_1': {
        'common_args': ['-X types/xml/struct_names.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_uint8 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_uint16 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_mustUnderstand_1': {
        'common_args': ['-X types/xml/struct_w_mustunderstand.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_mustUnderstand -V data/xml/struct_num_x1_x2.xml -J data/json/struct_num_x1_x2.json',
                 'sub-exe -S -t test -y Test::struct_int32 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_mustUnderstand_2': {
        'common_args': ['-X types/xml/struct_w_mustunderstand.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_int32 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_mustUnderstand -V data/xml/struct_num_x1_x2.xml -J data/json/struct_num_x1_x2.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_key_1': {
        'common_args': ['-X types/xml/struct_names.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_key_1 -V data/xml/struct_num_x1_x2.xml -J data/json/struct_num_x1_x2.json',
                 'sub-exe -S -t test -y Test::struct_key_2 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_key_2': {
        'common_args': ['-X types/xml/struct_names.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_key_2 -V data/xml/struct_num_x1.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_key_1 -V data/xml/struct_num_x1_x2.xml -J data/json/struct_num_x1_x2.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_key_string_1': {
        'common_args': ['-X types/xml/struct_names.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_key_string10 -V data/xml/struct_str_x1.xml -J data/json/struct_str_x1.json',
                 'sub-exe -S -t test -y Test::struct_key_string20 -V data/xml/struct_str_x1.xml -J data/json/struct_str_x1.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_key_string_2': {
        'common_args': ['-X types/xml/struct_names.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_key_string10 -V data/xml/struct_str_x1.xml -J data/json/struct_str_x1.json',
                 'sub-exe -S -t test -y Test::struct_key_string10 -V data/xml/struct_str_x1.xml -J data/json/struct_str_x1.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_key_string_3': {
        ...
        'common_args': ['-X types/xml/struct_names.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_key_string20 -V data/xml/struct_str_x1.xml -J data/json/struct_str_x1.json',
                 'sub-exe -S -t test -y Test::struct_key_string10 -V data/xml/struct_str_x1.xml -J data/json/struct_str_x1.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
    ...
    'struct_key_enum_1': {
        'common_args': ['-X types/xml/struct_names.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_key_enum_1 -V data/xml/struct_enum.xml -J data/json/struct_enum.json',
                 'sub-exe -S -t test -y Test::struct_key_enum_2 -V data/xml/struct_enum.xml -J data/json/struct_enum.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_key_enum_2': {
        ...
        # -- i expect INCONSISTENT_TOPIC here...
        'common_args': ['-X types/xml/struct_names.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_key_enum_2 -V data/xml/struct_enum.xml -J data/json/struct_enum.json',
                 'sub-exe -S -t test -y Test::struct_key_enum_1 -V data/xml/struct_enum.xml -J data/json/struct_enum.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_key_seq_1': {
        'common_args': ['-X types/xml/struct_names.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_key_seq10 -V data/xml/struct_seq.xml -J data/json/struct_seq.json',
                 'sub-exe -S -t test -y Test::struct_key_seq20 -V data/xml/struct_seq.xml -J data/json/struct_seq.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_key_seq_2': {
        ...
        # -- i expect INCONSISTENT_TOPIC here...
        'common_args': ['-X types/xml/struct_names.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_key_seq20 -V data/xml/struct_seq.xml -J data/json/struct_seq.json',
                 'sub-exe -S -t test -y Test::struct_key_seq10 -V data/xml/struct_seq.xml -J data/json/struct_seq.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_key_struct_1': {
        'common_args': ['-X types/xml/struct_names.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_key_struct_1 -V data/xml/struct_str_key.xml -J data/json/struct_str_key.json',
                 'sub-exe -S -t test -y Test::struct_key_struct_2 -V data/xml/struct_str_key.xml -J data/json/struct_str_key.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_key_struct_2': {
        ...
        # -- i expect INCONSISTENT_TOPIC here...
        'common_args': ['-X types/xml/struct_names.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_key_struct_2 -V data/xml/struct_str_key.xml -J data/json/struct_str_key.json',
                 'sub-exe -S -t test -y Test::struct_key_struct_1 -V data/xml/struct_str_key.xml -J data/json/struct_str_key.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_key_union_1': {
        'common_args': ['-X types/xml/struct_names.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_key_union_1 -V data/xml/struct_key_union.xml -J data/json/struct_key_union.json',
                 'sub-exe -S -t test -y Test::struct_key_union_2 -V data/xml/struct_key_union.xml -J data/json/struct_key_union.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_key_union_2': {
        'common_args': ['-X types/xml/struct_names.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_key_union_2 -V data/xml/struct_key_union.xml -J data/json/struct_key_union.json',
                 'sub-exe -S -t test -y Test::struct_key_union_1 -V data/xml/struct_key_union.xml -J data/json/struct_key_union.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
...
xtypes_v2_union_test_suite = {
    ...
    'union_primitives_final' : {
        'common_args' : ['-X types/xml/unions.xml'],
        'apps' : ['pub-exe -P -t test -y Test::union_primitives_final -V data/xml/union_primitive.xml -J data/json/union_primitive.json',
                  'sub-exe -S -t test -y Test::union_primitives_final -V data/xml/union_primitive.xml -J data/json/union_primitive.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'union_primitives_appendable': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_primitives_appendable -V data/xml/union_primitive.xml -J data/json/union_primitive.json',
                 'sub-exe -S -t test -y Test::union_primitives_appendable -V data/xml/union_primitive.xml -J data/json/union_primitive.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_primitives_mutable': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_primitives_mutable -V data/xml/union_primitive.xml -J data/json/union_primitive.json',
                 'sub-exe -S -t test -y Test::union_primitives_mutable -V data/xml/union_primitive.xml -J data/json/union_primitive.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_uint32_bitmask32': {
        'common_args': [''],
        'apps': ['pub-exe -P -t test -X types/xml/unions.xml         -y Test::union_uint32    -V data/xml/union_uint32.xml  -J data/json/union_uint32.json',
                 'sub-exe -S -t test -X types/xml/unions_bitmask.xml -y Test::union_bitmask32 -V data/xml/union_bitmask.xml -J data/json/union_bitmask.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_uint32_bitmask16': {
        'common_args': [''],
        'apps': ['pub-exe -P -t test -X types/xml/unions.xml         -y Test::union_uint32    -V data/xml/union_uint32.xml  -J data/json/union_uint32.json',
                 'sub-exe -S -t test -X types/xml/unions_bitmask.xml -y Test::union_bitmask16 -V data/xml/union_bitmask.xml -J data/json/union_bitmask.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_uint32_one_key': {
        'common_args': [''],
        'apps': ['pub-exe -P -t test -X types/xml/unions.xml                   -y Test::union_uint32     -V data/xml/union_uint32.xml -J data/json/union_uint32.json',
                 'sub-exe -S -t test -X types/xml/unions_key_discriminator.xml -y Test::union_uint32_key -V data/xml/union_uint32.xml -J data/json/union_uint32.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_different_ids_1': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_1 -V data/xml/union_x1.xml -J data/json/union_x1.json',
                 'sub-exe -S -t test -y Test::union_2 -V data/xml/union_x1.xml -J data/json/union_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_different_ids_2': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_1 -V data/xml/union_x1.xml -J data/json/union_x1.json',
                 'sub-exe -S -t test -y Test::union_2 -V data/xml/union_x1.xml -J data/json/union_x1.json --ignore-member-names f'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_different_names_1': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_3 -V data/xml/union_x1.xml -J data/json/union_x1.json',
                 'sub-exe -S -t test -y Test::union_4 -V data/xml/union_x2.xml -J data/json/union_x2.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_different_names_2': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_3 -V data/xml/union_x1.xml -J data/json/union_x1.json',
                 'sub-exe -S -t test -y Test::union_4 -V data/xml/union_x2.xml -J data/json/union_x2.json --ignore-member-names f'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_different_order_1': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_5 -V data/xml/union_x1.xml -J data/json/union_x1.json',
                 'sub-exe -S -t test -y Test::union_6 -V data/xml/union_x1.xml -J data/json/union_x1.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_different_order_2': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_5 -V data/xml/union_x1.xml -J data/json/union_x1.json',
                 'sub-exe -S -t test -y Test::union_6 -V data/xml/union_x1.xml -J data/json/union_x1.json --ignore-member-names f'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_int16_int32': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_int16 -V data/xml/union_x1.xml -J data/json/union_x1.json',
                 'sub-exe -S -t test -y Test::union_int32 -V data/xml/union_x1.xml -J data/json/union_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_int16_int32_default': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_int16         -V data/xml/union_x1.xml -J data/json/union_x1.json',
                 'sub-exe -S -t test -y Test::union_int32_default -V data/xml/union_x1.xml -J data/json/union_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_int32_int32_default': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_int32 -V data/xml/union_x1.xml -J data/json/union_x1.json',
                 'sub-exe -S -t test -y Test::union_int32_default -V data/xml/union_x1.xml -J data/json/union_x1.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
    ...
    'union_int32_default_int16': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_int32_default -V data/xml/union_x1.xml -J data/json/union_x1.json',
                 'sub-exe -S -t test -y Test::union_int16 -V data/xml/union_x1.xml -J data/json/union_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_int32_default_int16_default': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_int32_default -V data/xml/union_x1.xml -J data/json/union_x1.json',
                 'sub-exe -S -t test -y Test::union_int16_default -V data/xml/union_x1.xml -J data/json/union_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_final_5_vs_6': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_final_5 -V data/xml/union_x1.xml -J data/json/union_x1.json',
                 'sub-exe -S -t test -y Test::union_final_6 -V data/xml/union_x1.xml -J data/json/union_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_final_6_vs_5': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_final_6 -V data/xml/union_x1.xml -J data/json/union_x1.json',
                 'sub-exe -S -t test -y Test::union_final_5 -V data/xml/union_x1.xml -J data/json/union_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_final_one_default_1': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_final_5 -V data/xml/union_x1.xml -J data/json/union_x1.json',
                 'sub-exe -S -t test -y Test::union_final_5_default -V data/xml/union_x1.xml -J data/json/union_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_final_one_default_2': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_final_5_default -V data/xml/union_x1.xml -J data/json/union_x1.json',
                 'sub-exe -S -t test -y Test::union_final_5 -V data/xml/union_x1.xml -J data/json/union_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
    ...
    'union_appendable_one_common_1': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_appendable_a -V data/xml/union_a.xml -J data/json/union_a.json',
                 'sub-exe -S -t test -y Test::union_appendable_b -V data/xml/union_a.xml -J data/json/union_a.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_appendable_one_common_2': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_appendable_b -V data/xml/union_b.xml -J data/json/union_b.json',
                 'sub-exe -S -t test -y Test::union_appendable_a -V data/xml/union_b.xml -J data/json/union_b.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_appendable_no_common_1': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_appendable_a -V data/xml/union_a.xml -J data/json/union_a.json',
                 'sub-exe -S -t test -y Test::union_appendable_c -V data/xml/union_a.xml -J data/json/union_a.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_appendable_no_common_2': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_appendable_c -V data/xml/union_c.xml -J data/json/union_c.json',
                 'sub-exe -S -t test -y Test::union_appendable_a -V data/xml/union_c.xml -J data/json/union_c.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_appendable_no_common_w_default': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_appendable_a_default -V data/xml/union_xd.xml -J data/json/union_xd.json',
                 'sub-exe -S -t test -y Test::union_appendable_b_default -V data/xml/union_xd.xml -J data/json/union_xd.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_mutable_one_common': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_mutable_a -V data/xml/union_a.xml -J data/json/union_a.json',
                 'sub-exe -S -t test -y Test::union_mutable_b -V data/xml/union_a.xml -J data/json/union_a.json'],
        'expected_codes': [ReturnCode.OK, ReturnCode.OK],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_mutable_no_common': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_mutable_a -V data/xml/union_a.xml -J data/json/union_a.json',
                 'sub-exe -S -t test -y Test::union_mutable_c -V data/xml/union_a.xml -J data/json/union_a.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'union_mutable_no_common_w_default': {
        'common_args': ['-X types/xml/unions.xml'],
        'apps': ['pub-exe -P -t test -y Test::union_mutable_a_default -V data/xml/union_xd.xml -J data/json/union_xd.json',
                 'sub-exe -S -t test -y Test::union_mutable_b_default -V data/xml/union_xd.xml -J data/json/union_xd.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
...
xtypes_v2_primitive_test_suite = {
    ...
    'struct_uint8_uint8' : {
        'common_args' : ['-X types/xml/primitives.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'struct_uint8_uint16' : {
        'common_args' : ['-X types/xml/primitives.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_primitive_uint16 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'struct_uint8_uint32' : {
        'common_args' : ['-X types/xml/primitives.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                  'sub-exe -S -t test -y Test::struct_primitive_uint32 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes' : [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'struct_uint8_uint64': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_uint64 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_uint8_int8': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_int8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_uint8_int16': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_int16 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_uint8_int32': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_int32 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_uint8_int64': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_int64 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_uint8_float32': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_float32 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_uint8_float64': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_float64 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_uint8_float128': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_float128 -V data/xml/struct_primitives.xml -J data/json/struct_float128_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_uint8_byte': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_byte -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_uint8_char8': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_char8 -V data/xml/struct_primitives.xml -J data/json/struct_char_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
        'description': ''
    ...
    'struct_uint16_uint8': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_uint16 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
    ...
    'struct_uint32_uint8': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_uint32 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
    ...
    'struct_uint64_uint8': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_uint64 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
    ...
    'struct_int8_uint8': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_int8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
    ...
    'struct_int16_uint8': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_int16 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
    ...
    'struct_int32_uint8': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_int32 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
    ...
    'struct_int64_uint8': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_int64 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
    ...
    'struct_float32_uint8': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_float32 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
    ...
    'struct_float64_uint8': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_float64 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
    ...
    'struct_float128_uint8': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_float128 -V data/xml/struct_primitives.xml -J data/json/struct_float128_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
    ...
    'struct_byte_uint8': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_byte -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
    ...
    'struct_char8_uint8': {
        'common_args': ['-X types/xml/primitives.xml'],
        'apps': ['pub-exe -P -t test -y Test::struct_primitive_char8 -V data/xml/struct_primitives.xml -J data/json/struct_char_x1.json',
                 'sub-exe -S -t test -y Test::struct_primitive_uint8 -V data/xml/struct_primitives.xml -J data/json/struct_num_x1.json'],
        'expected_codes': [ReturnCode.INCONSISTENT_TOPIC, ReturnCode.INCONSISTENT_TOPIC],
        'check_function': tsf.data_is_correct,
        'title': '',
...
xtypes_v2_tryconstruct_test_suite = {
    'tryc_seq_1' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::seq_int32x20 -V data/xml/array_num_20.xml -J data/json/array_num_20.json',
                  'sub-exe -S -t test -y Test::seq_int32x10_trim -V data/xml/array_num_10.xml -J data/json/array_num_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_seq_2' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::seq_int32x20 -V data/xml/array_num_20.xml -J data/json/array_num_20.json',
                  'sub-exe -S -t test -y Test::seq_int32x10_discard -V data/xml/array_num_10.xml -J data/json/array_num_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_seq_3' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::seq_int32x20 -V data/xml/array_num_20.xml -J data/json/array_num_20.json',
                  'sub-exe -S -t test -y Test::seq_int32x10_default -V data/xml/tryconstruct/seq_num_empty.xml -J data/json/tryconstruct/seq_num_empty.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_seq_4' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::seq_int32x20 -V data/xml/array_num_20.xml -J data/json/array_num_20.json',
                  'sub-exe -S -t test -y Test::seq_int32x10 -V data/xml/array_num_10.xml -J data/json/array_num_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_str_1' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::string20 -V data/xml/strings.xml -J data/json/strings.json',
                  'sub-exe -S -t test -y Test::string10_trim -V data/xml/tryconstruct/strings_trim_10.xml -J data/json/tryconstruct/strings_trim_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_str_2' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::string20 -V data/xml/strings.xml -J data/json/strings.json',
                  'sub-exe -S -t test -y Test::string10_discard -V data/xml/tryconstruct/strings_trim_10.xml -J data/json/tryconstruct/strings_trim_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_str_3' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::string20 -V data/xml/strings.xml -J data/json/strings.json',
                  'sub-exe -S -t test -y Test::string10_default -V data/xml/tryconstruct/strings_default.xml -J data/json/tryconstruct/strings_default.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_str_4' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::string20 -V data/xml/strings.xml -J data/json/strings.json',
                  'sub-exe -S -t test -y Test::string10 -V data/xml/tryconstruct/strings_trim_10.xml -J data/json/tryconstruct/strings_trim_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_enum_1' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_enum_1 -V data/xml/tryconstruct/enum_val3.xml -J data/json/tryconstruct/enum_val3.json',
                  'sub-exe -S -t test -y Test::struct_enum_2_discard -V data/xml/tryconstruct/enum_val1.xml -J data/json/tryconstruct/enum_val1.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_enum_2' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_enum_1 -V data/xml/tryconstruct/enum_val3.xml -J data/json/tryconstruct/enum_val3.json',
                  'sub-exe -S -t test -y Test::struct_enum_2_default -V data/xml/tryconstruct/enum_val1.xml -J data/json/tryconstruct/enum_val1.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_enum_3' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::struct_enum_1 -V data/xml/tryconstruct/enum_val3.xml -J data/json/tryconstruct/enum_val3.json',
                  'sub-exe -S -t test -y Test::struct_enum_2 -V data/xml/tryconstruct/enum_val1.xml -J data/json/tryconstruct/enum_val1.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_union_seq_1' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::union_seq_int32x20 -V data/xml/tryconstruct/union_array_num_20.xml -J data/json/array_num_20.json',
                  'sub-exe -S -t test -y Test::union_seq_int32x10_trim -V data/xml/tryconstruct/union_array_num_10.xml -J data/json/array_num_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_union_seq_2' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::union_seq_int32x20 -V data/xml/tryconstruct/union_array_num_20.xml -J data/json/array_num_20.json',
                  'sub-exe -S -t test -y Test::union_seq_int32x10_discard -V data/xml/tryconstruct/union_array_num_10.xml -J data/json/array_num_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_union_seq_3' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::union_seq_int32x20 -V data/xml/tryconstruct/union_array_num_20.xml -J data/json/array_num_20.json',
                  'sub-exe -S -t test -y Test::union_seq_int32x10_default -V data/xml/tryconstruct/union_seq_num_empty.xml -J data/json/tryconstruct/seq_num_empty.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_union_seq_4' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::union_seq_int32x20 -V data/xml/tryconstruct/union_array_num_20.xml -J data/json/array_num_20.json',
                  'sub-exe -S -t test -y Test::union_seq_int32x10 -V data/xml/tryconstruct/union_array_num_10.xml -J data/json/array_num_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_union_str_1' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::union_string20 -V data/xml/tryconstruct/union_strings.xml -J data/json/strings.json',
                  'sub-exe -S -t test -y Test::union_string10_trim -V data/xml/tryconstruct/union_strings_trim_10.xml -J data/json/tryconstruct/strings_trim_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_union_str_2' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::union_string20 -V data/xml/tryconstruct/union_strings.xml -J data/json/strings.json',
                  'sub-exe -S -t test -y Test::union_string10_discard -V data/xml/tryconstruct/union_strings_trim_10.xml -J data/json/tryconstruct/strings_trim_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_union_str_3' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::union_string20 -V data/xml/tryconstruct/union_strings.xml -J data/json/strings.json',
                  'sub-exe -S -t test -y Test::union_string10_default -V data/xml/tryconstruct/union_strings_default.xml -J data/json/tryconstruct/strings_default.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_union_str_4' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::union_string20 -V data/xml/tryconstruct/union_strings.xml -J data/json/strings.json',
                  'sub-exe -S -t test -y Test::union_string10 -V data/xml/tryconstruct/union_strings_trim_10.xml -J data/json/tryconstruct/strings_trim_10.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_union_enum_1' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::union_enum_1 -V data/xml/tryconstruct/union_enum_val3.xml -J data/json/tryconstruct/enum_val3.json',
                  'sub-exe -S -t test -y Test::union_enum_2_discard -V data/xml/tryconstruct/union_enum_val1.xml -J data/json/tryconstruct/enum_val1.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_union_enum_2' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::union_enum_1 -V data/xml/tryconstruct/union_enum_val3.xml -J data/json/tryconstruct/enum_val3.json',
                  'sub-exe -S -t test -y Test::union_enum_2_default -V data/xml/tryconstruct/union_enum_val1.xml -J data/json/tryconstruct/enum_val1.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_union_enum_3' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::union_enum_1 -V data/xml/tryconstruct/union_enum_val3.xml -J data/json/tryconstruct/enum_val3.json',
                  'sub-exe -S -t test -y Test::union_enum_2 -V data/xml/tryconstruct/union_enum_val1.xml -J data/json/tryconstruct/enum_val1.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_union_enum_disc_1' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::union_disc_enum_1 -V data/xml/tryconstruct/union_x3.xml -J data/json/tryconstruct/union_x3.json',
                  'sub-exe -S -t test -y Test::union_disc_enum_2_discard -V data/xml/tryconstruct/union_x1.xml -J data/json/tryconstruct/union_x1.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_union_enum_disc_2' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::union_disc_enum_1 -V data/xml/tryconstruct/union_x3.xml -J data/json/tryconstruct/union_x3.json',
                  'sub-exe -S -t test -y Test::union_disc_enum_2_default -V data/xml/tryconstruct/union_x1.xml -J data/json/tryconstruct/union_x1.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    'tryc_union_enum_disc_3' : {
        'common_args' : ['-X types/xml/try_construct.xml'],
        'apps' : ['pub-exe -P -t test -y Test::union_disc_enum_1 -V data/xml/tryconstruct/union_x3.xml -J data/json/tryconstruct/union_x3.json',
                  'sub-exe -S -t test -y Test::union_disc_enum_2 -V data/xml/tryconstruct/union_x1.xml -J data/json/tryconstruct/union_x1.json'],
        'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
        'check_function' : tsf.data_is_correct,
        'title' : '',
        'description' : ''
    ...
    # 'tryc_union_1' : {
    #     'common_args' : ['-X types/xml/try_construct.xml'],
    #     'apps' : ['pub-exe -P -t test -y Test::union_tryconstruct_big -V data/xml/tryconstruct/union.xml -J data/json/tryconstruct/union_seq_num_20_x2.json',
    #               'sub-exe -S -t test -y Test::union_tryconstruct_small -V data/xml/tryconstruct/union.xml -J data/json/tryconstruct/union_seq_num_10_x2.json'],
    #     'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
    #     'check_function' : tsf.data_is_correct,
    #     'title' : '',
    #     'description' : ''
    ...
    # 'tryc_union_2' : {
    #     'common_args' : ['-X types/xml/try_construct.xml'],
    #     'apps' : ['pub-exe -P -t test -y Test::union_tryconstruct_big -V data/xml/tryconstruct/union.xml -J data/json/tryconstruct/union_seq_num_20_x3.json',
    #               'sub-exe -S -t test -y Test::union_tryconstruct_small -V data/xml/tryconstruct/union.xml -J data/json/tryconstruct/union_seq_num_10_x3.json'],
    #     'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
    #     'check_function' : tsf.data_is_correct,
    #     'title' : '',
    #     'description' : ''
    ...
    # 'tryc_union_3' : {
    #     'common_args' : ['-X types/xml/try_construct.xml'],
    #     'apps' : ['pub-exe -P -t test -y Test::union_tryconstruct_big -V data/xml/tryconstruct/union.xml -J data/json/tryconstruct/union_seq_num_20_x4.json',
    #               'sub-exe -S -t test -y Test::union_tryconstruct_small -V data/xml/tryconstruct/union.xml -J data/json/tryconstruct/union_seq_num_empty.json'],
    #     'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
    #     'check_function' : tsf.data_is_correct,
    #     'title' : '',
    #     'description' : ''
    ...
    # 'tryc_union_4' : {
    #     'common_args' : ['-X types/xml/try_construct.xml'],
    #     'apps' : ['pub-exe -P -t test -y Test::union_tryconstruct_big -V data/xml/tryconstruct/union.xml -J data/json/tryconstruct/union_str_20_x5.json',
    #               'sub-exe -S -t test -y Test::union_tryconstruct_small -V data/xml/tryconstruct/union.xml -J data/json/tryconstruct/union_str_trim10_x5.json'],
    #     'expected_codes' : [ReturnCode.OK, ReturnCode.OK],
    #     'check_function' : tsf.data_is_correct,
    #     'title' : '',
    #     'description' : ''
    ...
    # 'tryc_union_5' : {
    #     'common_args' : ['-X types/xml/try_construct.xml'],
    #     'apps' : ['pub-exe -P -t test -y Test::union_tryconstruct_big -V data/xml/tryconstruct/union.xml -J data/json/tryconstruct/union_str_20_x6.json',
    #               'sub-exe -S -t test -y Test::union_tryconstruct_small -V data/xml/tryconstruct/union.xml -J data/json/tryconstruct/union_str_10_x6.json'],
    #     'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
    #     'check_function' : tsf.data_is_correct,
    #     'title' : '',
    #     'description' : ''
    ...
    # 'tryc_union_6' : {
    #     'common_args' : ['-X types/xml/try_construct.xml'],
    #     'apps' : ['pub-exe -P -t test -y Test::union_tryconstruct_big -V data/xml/tryconstruct/union.xml -J data/json/tryconstruct/union_str_20_x7.json',
    #               'sub-exe -S -t test -y Test::union_tryconstruct_small -V data/xml/tryconstruct/union.xml -J data/json/tryconstruct/union_str_default.json'],
    #     'expected_codes' : [ReturnCode.OK, ReturnCode.DATA_NOT_RECEIVED],
    #     'check_function' : tsf.data_is_correct,
    #     'title' : '',
    #     'description' : ''
